...
const knowledgeItems = [
  {
    ...
    link: '/research-goals',
    bg: 'var(--color-domain-nucleotide-soft)',
  ...
  },
  {
    ...
    link: '/applications',
    bg: 'var(--color-domain-click-soft)',
    color: 'var(--color-domain-click)',
  },
  {
    icon: '🔬',
    title: 'Methods',
    ...
    link: '/methods',
    bg: 'var(--color-domain-fluor-soft)',
    color: 'var(--color-domain-fluor)',
  },
  {
    icon: '📋',
    title: 'Protocols',
