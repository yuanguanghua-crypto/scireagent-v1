...
<style scoped>
.product-edit { max-width: var(--content-max-width); margin: 0 auto; }
...
.save-msg--success { background: var(--color-success-light); color: var(--color-primary-active); }
...
.chip:hover { border-color: var(--color-primary, #059669); }
.chip-active { background: var(--color-primary, #059669); border-color: var(--color-primary, #059669); color: white; }
</style>
