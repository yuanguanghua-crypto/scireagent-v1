...
.error-msg {
  padding: 10px 14px; background: var(--color-danger-light); color: #991b1b; border-radius: var(--radius-md); font-size: 13px; margin-bottom: 12px;
}
...
.lipinski-pass { background: var(--color-success-light); color: var(--color-primary-active); }
.lipinski-fail { background: var(--color-warning-light); color: var(--color-warning); }
...
.chip {
  ...
  background: var(--color-info-light); color: #1e40af;
}
.unmatched-chip { background: var(--color-warning-light); color: var(--color-amber-800); }
