...
.toast.error { background: var(--color-danger-light); color: #991b1b; }
...
.error-text { font-size: 11px; color: var(--color-red-500); }
...
.btn-remove { background: none; border: none; color: var(--color-red-500); cursor: pointer; font-size: 16px; }
