  ...
  <div class="dashboard">
    ...
    <template v-else>
      ...
      <div class="section">
        ...
        <EmptyState v-else title="No products yet" icon="Goods" />
      </div>
    </template>
  </div>
</template>
...
.stat-card { background: var(--color-surface); border: 1px solid var(--color-border); border-radius: 4px; padding: 20px; text-align: center; }
...
.health-grid { background: var(--color-surface); border: 1px solid var(--color-border); border-radius: 4px; padding: 16px; display: flex; flex-direction: column; gap: 12px; }
...
.kg-grid { background: var(--color-surface); border: 1px solid var(--color-border); border-radius: 4px; padding: 16px; display: flex; gap: 24px; font-size: 14px; color: var(--color-text); }
.recent-table { width: 100%; border-collapse: collapse; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: 4px; overflow: hidden; }
