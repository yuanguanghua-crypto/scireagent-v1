...
function getTypeColor(type) {
  const map = { products: 'var(--color-success)', applications: 'var(--color-entity-app)', methods: 'var(--color-info)', protocols: 'var(--color-warning)', references: 'var(--color-text-secondary)' }
...
<style scoped>
.search-page { max-width: var(--content-max-width); margin: 0 auto; padding: 24px; }
