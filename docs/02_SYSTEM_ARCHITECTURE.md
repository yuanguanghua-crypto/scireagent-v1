<!-- DEPRECATED: 本文件是项目初始设计阶段（2026-06-11）的思路草案，代表 "LabPro Global" 的早期系统架构。不代表当前代码库的实际实现，不应作为编码决策的依据。

当前权威文档：CLAUDE.md（根目录）→ 架构铁律、分层架构、技术栈；KNOWLEDGE_ASSETS.md → 知识图谱体系。
