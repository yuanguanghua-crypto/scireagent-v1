<!-- DEPRECATED: 本文件是项目初始设计阶段（2026-06-11）的变更约束规则草案，代表 "LabPro Global" 早期的 Codex 开发纪律。不代表当前代码库的实际约束，不应作为编码决策的依据。

当前权威文档：CLAUDE.md → 架构铁律、代码味道速查、权限速查、坑列表、测试命令；docs/KNOWLEDGE_ROADMAP.md → 当前优化待办。
