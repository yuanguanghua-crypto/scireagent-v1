<!-- DEPRECATED: 本文件是项目初始设计阶段（2026-06-11）的设计系统草案，代表 "LabPro Global" 早期的视觉规范。不代表当前前端代码库的实际实现，不应作为前端实现的依据。

当前权威文档：docs/design/DESIGN_SYSTEM.md → 当前设计系统；frontend/src/ → 实际组件实现。
