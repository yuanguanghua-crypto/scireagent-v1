<!-- DEPRECATED: 本文件是项目初始设计阶段（2026-06-11）的路线图草案，代表 "LabPro Global" 的早期阶段规划。不代表当前项目实际进展，不应作为迭代规划的依据。

当前权威文档：KNOWLEDGE_ROADMAP.md → 当前演进 backlog（P0/P1/P2 分级）；CLAUDE.md → 项目当前状态与技术栈。
