...
def site_home(request):
    ...
    # Categories — L1 breakdown with product counts (DB-driven via ProductClass)
    ...
    categories_payload = []
    for l1_slug, meta in CATEGORY_META.items():
        descendant_ids = get_descendant_product_class_ids(l1_slug)
